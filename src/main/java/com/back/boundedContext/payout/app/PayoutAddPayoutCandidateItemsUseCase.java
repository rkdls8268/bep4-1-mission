...
public class PayoutAddPayoutCandidateItemsUseCase {
  ...
  public void addPayoutCandidateItems(OrderDto order) {
    ...
    orderItems.forEach(orderItem -> {
      this.makePayoutCandidateItems(order, orderItem);
    });
  }
  ...
  private void makePayoutCandidateItems(
    ...
    PayoutMember buyer = payoutSupport.findMemberById(orderItem.getBuyerId());
    PayoutMember seller = payoutSupport.findMemberById(orderItem.getSellerId());

    this.makePayoutCandidateItem(
